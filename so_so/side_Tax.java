//เดี๋ยวค่อยเขียนแยก method ขี้เกียจละ
...
class side_Tax {
    public static void main(String[] args) {
        ...
        int Salary = kbd.nextInt();
        System.out.print("Enter Year cost: ");
        int Year_cost = kbd.nextInt();
        System.out.print("Enter Tax deduction: ");
        int Tax_deduction = kbd.nextInt();
        System.out.println();
        ...
        if (amount >= 0 && amount <= 150000)
            tax = 0.0 / 100.0;
        else if (amount >= 150001 && amount <= 300000)
            tax = 5.0 / 100.0;
